...
public class Training {
	...
	public static void loadParametersAndData(String[] args) throws FileNotFoundException {
		...
		System.out.println("Go and look up "+"/data/aa1/PhD_Sem4/Rijurekha/"+model+"_"+Z+"topics"+ ". That's where the output is.");
		//System.setOut(new PrintStream(new File("C:\\Aditya\\Output\\"+model+"_"+Z+"topics_"+samples+"samples_"+
		//									words_thresh+"wordsthresh")));
