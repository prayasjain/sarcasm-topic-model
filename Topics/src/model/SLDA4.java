...
/*
* 24th October 2013.
* modified version of Aspect and Sentiment Unification Model for Online Review Analysis
* Assumes that sentence-sentiment labels are known.
*/
public class SLDA4 {
	...
	public double[][][] estimate(int[][] w_di, int[][] s_di, String[] l_w,int W, int D, long N, int Z, int S, double a, double b, double g, int burnIn, int samples, int step) {
		...
		for (int iteration=0; iteration<burnIn+samples; iteration++) {    // Aadi: For burn-in + samples number of iterations
			...
			for (int d=0; d<D; d++) { // document d
				...
				for (int i=0; i<w_di[d].length; ) { 
					...
					// Remove last values corresponding to z
					do
					{
